...
class Config(object):
    ...
    PERMANENT_SESSION_LIFETIME = datetime.timedelta(days=365, hours=0, minutes=0, seconds=0)
    ...
    AWS_SECRET_ACCESS_KEY = os.environ.get('AWS_SECRET_ACCESS_KEY') or env_config['AWS_SECRET_ACCESS_KEY']
    AWS_S3_BUCKET = os.environ.get('AWS_S3_BUCKET') or env_config['AWS_S3_BUCKET']
    AWS_S3_USER_FILE_FOLDER = os.environ.get('AWS_S3_USER_FILE_FOLDER') or env_config['AWS_S3_USER_FILE_FOLDER']
    CELERY_BROKER_URL = os.environ.get('CELERY_BROKER_URL') or env_config['CELERY_BROKER_URL']
    CELERY_RESULT_BACKEND = os.environ.get('CELERY_RESULT_BACKEND') or env_config['CELERY_RESULT_BACKEND']
